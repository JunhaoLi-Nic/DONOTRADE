        ...
        try {
            ...
            if (param1) { // if param1 == true then we're not on screenshots page
                if(!param2) {
                    ...
                    params.excludeFields = "originalBase64,annotatedBase64,maState";
                } else {
                    console.log("  --> Getting full Screenshots data");
                    params.dateUnixDay = param2;
                }
            } else { // if param1 inexistant or = false then we're on screenshots page
                params.limit = screenshotsQueryLimit.value;
                params.skip = screenshotsPagination.value;
            }
                ...
                parsedResult.forEach(element => {
                    ...
                    const pushScreenshots = () => {
                        if (!param1 || param2) {
                            ...
                            let temp = {};
                            temp.objectId = element.objectId || element.id;
            ...
            if (sessionStorage.getItem('screenshotIdToEdit') && pageId.value == "screenshots") {
                useScrollToScreenshot();
            }
